// Path: SaloonOS.Application/Common/Contracts/IAppointmentRepository.cs
...
public interface IAppointmentRepository : IRepository<Appointment>
{
    ...
    Task<List<Appointment>> GetScheduledAppointmentsForShopByDayAsync(Guid shopId, DateTime date);
}